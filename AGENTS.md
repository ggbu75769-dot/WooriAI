...
- Use `pnpm@11.7.0` as declared in package.json; Android package: `kr.wooriai.app` (`apps/mobile/app.json`). Avoid repeated installs or complete builds for documentation-only changes.
...
Read `docs/dev/do-not-change.md` for the single locked-behavior contract.
