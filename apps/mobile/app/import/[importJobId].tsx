 ...
 * 그대로다.
 *
 * ⚠️ 두 시점(토스 리뷰 L — DNC-018 해석 기록): DNC-018은 고정 UX 문구의 해요체 톤을 잠근다.
 * 이 개정은 배지 6종을 해요체 문장("분석 진행 중이에요" 등)에서 명사형("분석 중")으로
 * 옮겼다 — 해석은 **배지는 문장이 아니라 상태 표라 명사형이 허용된다**이고, 근거는 기존
 * 명사형 배지 선례("가져오기 완료" — 종전부터 이 표 안에 있었다)와 톤 의미 불변이다. 이
 * 해석이 다른 배지 표에도 서는 날 계약(스윕)으로 승격한다 — 그 전까지 이 주석이 기록이다.
 */
