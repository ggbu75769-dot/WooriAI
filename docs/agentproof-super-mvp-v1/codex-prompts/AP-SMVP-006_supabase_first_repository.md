# AP-SMVP-006 — Supabase-first Repository 전환
...
```text
AP-SMVP-006 — Supabase-first Repository 전환 작업을 수행해줘.
대상 저장소는 agentproofKR/agentproofKR.github.io 하나뿐이다.
목표: localStorage를 source of truth가 아니라 fallback/cache로 낮추고, live project는 Supabase summary와 mutation을 우선 사용하게 한다.
