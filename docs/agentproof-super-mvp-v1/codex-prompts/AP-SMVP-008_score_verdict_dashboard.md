# AP-SMVP-008 — ProofScore/Verdict Dashboard 연결
...
```text
AP-SMVP-008 — ProofScore/Verdict Dashboard 연결 작업을 수행해줘.
대상 저장소는 agentproofKR/agentproofKR.github.io 하나뿐이다.
목표: proofCore의 ProofScore/Verdict를 Evidence Dashboard와 Board summary에 연결한다.
