# AP-SMVP-010 — Access Token Exchange/Scope 강화
...
```text
AP-SMVP-010 — Access Token Exchange/Scope 강화 작업을 수행해줘.
대상 저장소는 agentproofKR/agentproofKR.github.io 하나뿐이다.
목표: board_access/report_view token scope, expiry, revoke, exchange를 강화한다.
