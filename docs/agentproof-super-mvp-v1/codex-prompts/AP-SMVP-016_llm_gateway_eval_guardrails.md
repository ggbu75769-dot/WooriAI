# AP-SMVP-016 — LLM Gateway/Eval Guardrails
...
```text
AP-SMVP-016 — LLM Gateway/Eval Guardrails 작업을 수행해줘.
대상 저장소는 agentproofKR/agentproofKR.github.io 하나뿐이다.
목표: AI output schema, provider fallback, deterministic risk review를 강화한다.
