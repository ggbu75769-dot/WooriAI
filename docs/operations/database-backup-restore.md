...
## 보존 기간과의 관계 (숫자 정합 — 2026-08-28, GAP-058 #10 · GAP-060 #5 · GAP-062 #8)
...
| **가족 초대 행** (10단계) | **90일** | `HOUSEHOLD_INVITES_RETENTION_DAYS` | 만료·수락·취소된 초대만, 유효기간(`expires_at`) 기준. **pending(살아 있는 링크)은 제외.** 수락은 구성원 행이·취소는 감사 로그가 따로 보존하므로 중복 보존의 해소다. ⚠️ **짧게 조정하는 것은 PM 확인 대상** |
