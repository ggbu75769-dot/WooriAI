...
| EXP-001 | valid | 0.1729 | fail | bottom-tab/footer 0.3094, content/list/cards 0.2247 |
...
## Next
1. Continue visual tuning now that all 9 screens have `renderValid=true` and `release:gate` is green.
2. Tune Phase A screens in order: `SPL-001`, `IMP-003`, `EXP-001`; always guard `SET-001`.
3. Run full Android gate after each accepted phase.
