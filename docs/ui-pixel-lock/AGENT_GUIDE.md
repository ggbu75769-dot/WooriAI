...
- Locked behavior (DNC-001~020) has **one source**: [`docs/dev/do-not-change.md`](../dev/do-not-change.md) (v0.5).
...
[`docs/dev/do-not-change.md`](../dev/do-not-change.md) (DNC-001~020, v0.5).
