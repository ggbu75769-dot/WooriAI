...
describe("ⓖ 문서가 옮겨 적은 이 계약의 상수 — 오늘 값의 정합 (라운드 91 트랙 E)", () => {
  ...
  it("ⓐ 모집단이 0건이 아니고, 오늘 자리는 셋이다 (유령 방지)", () => {
    ...
    expect(
      ...
      // ⚠️⚠️ **두 시점 — 이 좌표는 라운드마다 갱신되는 값이다**(라운드 92 트랙 F).
      //  · **라운드 91 트랙 F 시점**: `22 · 1223 · 1267`(그 앞 라운드 91 트랙 E 커밋 시점은
      //    `22 · 1153 · 1188`이었다).
      //  · **오늘(라운드 92 트랙 F 뒤)**: `22 · 1281 · 1333` — F가 A-33 절(#108)과 C-3의 세 자리
      //    갱신을 이 문서에 적으면서 아래 두 자리가 밀렸다(`:22`는 A절보다 위라 움직이지 않는다).
