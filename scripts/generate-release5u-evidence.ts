...
async function main() {
  ...
  write("release5u-icon-audit.json", { schemaVersion: 1, generatedAt, status: iconAssets.every((asset) => asset.dimensionsPass) ? "AUTOMATED_PASS" : "FAIL", actor: "Accessibility and Brand Engineer", input: "repo-native SVG and generated PNG pipeline", mission: "recognizable family protection and growth mark", primaryIconFamily: "MaterialCommunityIcons", sourceImports: 3, rules: { functionalEmoji: 0, default: 24, compact: 20, large: 28, decorativeHidden: true, iconOnlyLabelRequired: true }, concept: "one continuous coral nest protects a central seed and mint sprout", assets: iconAssets, runtimeOnly: ["launcher mask rendering", "notification rendering on OEM devices", "installed 24px/48px appearance"] });
